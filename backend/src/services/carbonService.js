...
class CarbonService {
  ...
  static getFootprintCategory(totalCO2) {
    if (totalCO2 <= 3000) return { categoria: 'Bajo', color: '#22c55e' };
    if (totalCO2 <= 7000) return { categoria: 'Medio', color: '#eab308' };
    if (totalCO2 <= 12000) return { categoria: 'Alto', color: '#f97316' };
